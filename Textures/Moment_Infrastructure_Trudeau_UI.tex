...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="C:\Users\otaku\OneDrive\Desktop\Civ VI SDK\Civ VI Leaders\Justin Trudeau\Textures\Moment_Infrastructure_Trudeau_UI.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3030767284</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Moment_Infrastructure_Trudeau_UI.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Moment_Infrastructure_Trudeau_UI"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
